...
@Profile("prod") // only for production
@Repository
public class OracleEmployeeDaoImpl implements IEmployeeDAO
{
	...
	{
		System.out.println("Oracle Code executing.......................");
	...
	static
	{
		System.out.println("OracleEmployeeDaoImpl.class file loading............");
	}

	public OracleEmployeeDaoImpl()
	{
		System.out.println("OracleEmployeeDaoImpl bean object instantiated.............");
	}
}
