...
public class CoronaVaccine implements Serializable
{
	...
	public CoronaVaccine()
	{
		...
		/**
		 * Hibernate does this to create an instance of the entity class and then
		 * populate its properties with the values retrieved from the database.
		 */
	}

	// for easy creation of object
