...
public class StudentDaoImpl implements IStudentDao
{
	...
	{
		// Query the database and map the result to a StudentBO object using
	...
	{
		// Query the database and map the result to a list of StudentBO objects using a
		// lambda expression
